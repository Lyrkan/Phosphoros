          ...
          <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Text className="text-muted">
                How the bed movement is controlled:
                <ul>
                  <li><strong>GRBL</strong> - Control the bed using GRBL commands sent to FluidNC</li>
                  <li><strong>Control Board (stepper)</strong> - Uses the stepper driver on the control board</li>
                </ul>
              </Form.Text>
            </Form.Group>
